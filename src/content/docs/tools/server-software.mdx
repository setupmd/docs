...
NeoForge is a fork of the Forge project with almost all of the original team excluding LexManos made to fix its community issues and to provide better support to modders and later versions of Minecraft.
<LinkCard
  title="Download"
