...
<ul class="pl-5 list-disc">
    ...
    <li>Passive advertising on the Connect network allows for extra player traffic (can be disabled with paid plan)</li>
    <li>Custom domains are supported and free</li>
</ul>
