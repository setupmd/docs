---
slug: administration/server-software
...
#### Vanilla <Badge text="NO PLUGIN SUPPORT" variant="danger" size="medium" />
...
#### Paper <Badge text="RECOMMENDED" variant="success" size="medium" />
