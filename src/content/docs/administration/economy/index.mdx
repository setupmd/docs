...
### Requirements
Most, if not all plugins require your server to have an Economy API (such as [Vault](/customise/plugins/core/vault)) and an Economy Handler installed. 

Some example economy handlers are below:

<ul class="pl-5 list-disc">
    <li>[EssentialsX](/customise/plugins/core/essentialsx)</li>
    <li>[TheNewEconomy](https://www.spigotmc.org/resources/the-new-economy.7805/) (Optional Vault Support)</li>
    <li>[Gringott's Economy](https://www.spigotmc.org/resources/gringotts.42071/)</li>
</ul>