...
<ul class="pl-5 list-disc">
    <li>[AuctionHouse](https://www.spigotmc.org/resources/auctionhouse.61836/)</li>
    <li>[PlayerAuctions](/customise/plugins/economy/playerauctions)</li>
    <li>[PlayerShops (BPS)](https://www.spigotmc.org/resources/playershops-gui-bsp-allow-players-to-create-public-shops.29568/updates)</li>
    <li>[zAuctionHouse](/customise/plugins/economy/zauctionhouse)</li>
</ul>