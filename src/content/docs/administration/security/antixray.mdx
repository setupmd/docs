...
slug: administration/security/antixray
...
<LinkCard
  title="Paper Anti-Xray Documentation"
  description="View PaperMC's official documentation on how to set up Anti-Xray."
  href="https://docs.papermc.io/paper/anti-xray"
/>
