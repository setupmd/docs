...
<LinkCard
  title="Github"
  description="View The official TAB optimisation guide GitHub page for optimising this page."
...
<LinkCard
  title="Modrinth"
  description="View Topper's official Modrinth page for downloading the plugin."
...
<CardGrid>
  <LinkCard title="Grim AC" href="https://github.com/GrimAnticheat/Grim"/>
...
<LinkCard
  title="GitHub"
  description="View FreshSMP's official Github page for downloading the plugin."
...
<LinkCard
  title="GitHub"
  description="View Quantiom's official Github page for downloading the plugin."
