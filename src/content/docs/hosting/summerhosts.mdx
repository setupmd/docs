...
For hosting providers that meet the requirements below but are not already on the list you can [submit an issue on GitHub](https://github.com/setupmd/docs/issues/new?assignees=&labels=&projects=&template=summerhost-addition.yml). Providers that no longer meet the criteria defined below can request removal using [this link](https://github.com/setupmd/docs/issues/new?assignees=&labels=&projects=&template=summerhost-removal.yml)
...
| [Ravnix](https://ravnix.net/) | Refusing to refund customers (despite their SLA), possibly pirated billing software |
| [RocketNode](https://rocketnode.com/) | Oversold servers/Deceptive sales,unauthorized GSP selling FiveM servers |
