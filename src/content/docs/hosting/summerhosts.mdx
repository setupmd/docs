...
| [GustyHost](https://gustyhost.cloud/) | No public Terms of Service or Privacy Policy, filler text on reviews, and improper (Discord) checkout |
| [Galeniusnodes](https://galeniusnodes.cloud/) | No publicly available SLA, claiming to be a registered company when they are not, and lying about uptime |
| [MineStrator](https://minestrator.com/) | No publicly available SLA |
| [HammerVM](https://hammervm.com/) | Owner is illegally purchasing servers from a 13 year old because he has to declare any servers he owns due to having a history of hosting CSAM |
| [Vertex Hosting](https://vertexhosting.co.uk/) | Rigging reviews, no Privacy Policy, and improper (Discord) checkout |
