...
### MCHO.ST (YourGameHost)

MCHO.ST is a hosting provider with both a free and premium tier, the latter using the Ryzen 8700G CPUs offering great price to performance with a brand new panel.

<ul class="pl-5 list-disc">
    <li>Location: Nuremburg (Free Tier), London (Premium Tier), New York (Free Tier)</li>
</ul>
...
<ul class="pl-5 list-disc">
    ...
    <li>Premium: £1.20/GB/month</li>
</ul>

<LinkCard
  title="Website"
  href="https://yourgamehost.com"
/>
