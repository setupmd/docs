...
<br/>
<Image src="https://cdn.setup.md/uploads_files_ce2536b2f07c478fc7c57d15b2331d47.png" alt="Chat Signing Technical Details" width="750px" height="750px" />
...
##### Edit server.properties file <Badge text="GLOBAL" variant="success" />
...
##### No Chat Reports <Badge text="MODDED ONLY" variant="caution" size="medium" />
...
##### FreedomChat <Badge text="Spigot, Paper & Forks" variant="caution" size="large" />
...
##### AntiPopup <Badge text="Spigot, Paper & Forks" variant="caution" size="large" />
...
##### UnSignedVelocity <Badge text="VELOCITY ONLY" variant="caution" size="medium" />
