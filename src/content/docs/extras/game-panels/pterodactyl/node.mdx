---
slug: extras/game-panels/pterodactyl/node
...
![Admin View](https://cdn.setup.md/pterodactyl-ui/adminview.png)  
![Sidebar](https://cdn.setup.md/pterodactyl-ui/sidebar.png)
...
![Not Behind Proxy](https://cdn.setup.md/pterodactyl-ui/radio.png)
:::

After you've created your node, go to the Configuration tab.  
![Configuration](https://cdn.setup.md/pterodactyl-ui/configuration.png)
...
![Auto-Deploy](https://cdn.setup.md/pterodactyl-ui/autodeploy.png)
