---
slug: extras/game-panels/pterodactyl/panel
...
This guide is based on Pterodactyl's own [documentation](https://pterodactyl.io/panel/1.0/getting_started.html). This guide also assumes that you have the following, for further assistance consult the setup.md [Discord server](https://discord.gg/pXaQgzneed).  
...
sudo zerossl-bot --nginx -m me@example.com -d panel.example.com
