...
slug: deploy/considerations/hosting-types
topic: deploy
...
### Shared Hosting <Badge text="Best for Majority" variant="success" size="medium" />
...
### Virtual Private Servers <Badge text="Technical Users" variant="caution" size="medium" />
...
<ul class="pl-5 list-disc">
    ...
    <li>You can install a custom panel such as [Pterodactyl](/deploy/panels#pterodactyl)</li>
</ul>
...
### Bare Metal / VDS <Badge text="Enterprise" variant="default" size="medium" />
...
### Option 1: Rented Hardware <Badge text="Advanced" variant="danger" size="medium" />
...
### Option 2: Home Hosting <Badge text="Most Affordable" variant="tip" size="medium" />
...
<ul class="pl-5 list-disc">
    ...
    <li>Do you have proper IPv4 addresses? Yes, Minecraft *can* support IPv6 but it requires all parties involved to also support V6 connectivity. You also need to consider if you have a [static IPv4 address](/fix/nat).</li>
