...
slug: deploy/considerations/panels
topic: deploy
...
### AMP <Badge text="WINDOWS & LINUX" variant="note" />
...
### Moonlight <Badge text="LINUX" variant="note" />
...
### Pterodactyl <Badge text="LINUX" variant="note" />
...
### PufferPanel <Badge text="LINUX" variant="note" />
