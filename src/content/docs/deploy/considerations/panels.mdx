...
### AMP <Badge text="WINDOWS & LINUX" variant="info" />
...
### Moonlight <Badge text="LINUX" variant="info" />
...
### Pterodactyl <Badge text="LINUX" variant="info" />
...
### PufferPanel <Badge text="LINUX" variant="info" />
