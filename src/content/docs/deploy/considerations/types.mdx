...
### Shared Hosting :badge[BEST OPTION MOST PEOPLE]{variant=success}
...
The other common response you'll see people mention is 'grab yourself a VPS from Digital Ocean or Linode'. While you certainly can, it won't be much better than using [oracle cloud](/extras/oracle-cloud) on ARM (which is free). 
...
<ul class="pl-5 list-disc">
    ...
    <li>You can install a custom panel such as [Pterodactyl](/deploy/panels#pterodactyl-linux-only)</li>
</ul>
