...
slug: deploy/create/standalone/linux
topic: deploy
...
This guide will not cover the basics of deploying Windows, securing your OS and patch automation as we have already covered those within our [lab](/lab/hardening) series.
