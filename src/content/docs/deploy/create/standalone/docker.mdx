...
slug: deploy/create/standalone/docker
topic: deploy
...
We have already covered how to deploy Docker to a VPS within our [lab series](/lab/docker#deployment), you should follow this guide if you have not got a working instance. Other great resources for this exist within the [DigitalOcean Community forum](https://www.digitalocean.com/community).
...
The process of setting up Grafana and adding sources / dashboards can be found within our [lab series](/lab/monitoring).
