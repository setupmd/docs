...
slug: deploy/create/install-java
topic: deploy
...
1. Go to the [Microsoft OpenJDK Downloads](https://learn.microsoft.com/en-us/java/openjdk/download) page.
2. Select the macOS installer for the latest LTS version of Java.
...
1. Go to the [Microsoft OpenJDK Downloads](https://learn.microsoft.com/en-us/java/openjdk/download) page.
2. Choose the Windows installer (`.exe`) for the latest LTS version of Java.
