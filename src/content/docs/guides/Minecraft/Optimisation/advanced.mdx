...
#### ajLeaderboards
ajLeaderboards is famous for causing crashes thanks to it's generation of thousands of threads (over 50k!) We recommend finding an alternative such as Topper.
