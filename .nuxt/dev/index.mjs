...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getResponseStatusText } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/@unhead/ssr/dist/index.mjs';
...
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/scule/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/ufo/dist/index.mjs';
...
import { extname } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/pathe/dist/index.mjs';
...
import { postprocess, preprocess } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/micromark/dev/index.js';
...
import { markdownLineEnding, markdownSpace } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/micromark-util-sanitize-uri/dev/index.js';
...
import { version, unref } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/danielsmith/Documents/GitHub/docs/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/danielsmith/Documents/GitHub/docs/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const parseMarkdown = async (md, opts = {}) => {
  if (!moduleOptions) {
    moduleOptions = await import(
      'file:///Users/danielsmith/Documents/GitHub/docs/.nuxt/mdc-imports.mjs'
      /* @vite-ignore */
    ).catch(() => ({}));
  }
...
const _lazy_MlMhBJ = () => Promise.resolve().then(function () { return search$1; });
const _lazy_HNCDZv = () => Promise.resolve().then(function () { return opensearch_xml$1; });
const _lazy_OJoGF8 = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _IfNHL5, lazy: false, middleware: false, method: "get" },
...
const getClientManifest = () => import('file:///Users/danielsmith/Documents/GitHub/docs/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/danielsmith/Documents/GitHub/docs/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
