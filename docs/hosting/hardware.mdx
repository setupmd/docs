...
If you're at this part of our hosting tips, we assume you've already decided on the type of hosting you want to go for. If you haven't identified the type of hosting you wish to go for it's highly recommended to read our [types of hosting](types.mdx) document first.

:::note
The first point we want to stress is **do not go out and buy the latest flagship CPU for your own single Minecraft server**. This is a complete waste of money and you will not be able to utilise the full CPU, you should however find a hosting provider that offers the desired CPU line up and use 'shared hosting'.
:::
