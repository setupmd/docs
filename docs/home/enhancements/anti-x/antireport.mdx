...
This document serves as a guide for those who want to stop reports going out from servers to Mojang.
...
Below is a list of ways server owners and players can effectively disable the new chat reporting feature
