...
- You can install a custom panel such as [Pterodactyl](panels#pterodactyl)
...
:::info
If you don't already know what level of hardware you should be looking at then please consider reading our [hardware guide](hardware) first.
:::
...
- Bloom Host - Shared Hosting, VPS & Bare Metal
