...
Yes, Folia is relatively usable. Do you need to use it? Highly unlikely. Can you use it? Probably. Will a good chunk of your plugins break? Definitely. Solutions to said plugin breakages are probably not too complicated, though. Only recommended for very large servers that are vanilla/semi-vanilla, have a beefy enough CPU and enough threads as well. If you do end up using it, make sure to test it thoroughly. Every command and feature should be tested.
...
### [Geyser Standalone](https://geysermc.org/download#standalone)
