...
Do you need to use it? Highly unlikely.  Can you use it? Probably.  Will a good chunk of your plugins break? Definitely.  It's currently only recommended for very large servers that are vanilla/semi-vanilla, have a beefy enough CPU and enough threads as well. If you do end up using it, make sure to test it thoroughly. 
