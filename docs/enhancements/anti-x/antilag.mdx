...
A guide to optimizing your server has been made on setup.md already. Please click on the button below to read it.

<div>
<a class="button button--outline button--primary" href="https://www.setup.md/guides/optimizing">Guide</a>
</div>
