...
<ul>
    ...
    <li>x2 Bare Metal Nodes (Adv-1 G2)</li>
...
If you have further host servers you should also configure those now changing VS01 to the repsective number.
...
Once this has been completed you will see a 'Virtual MAC Address', keep a note of this as it will be important when configuring pfSense.
...
:::info
Do not activate the firewall rules until you have deployed the pfSense VM otherwise you will not be able to access the Proxmox UI
:::
...
------------ | ------- | -------- | --------- | ----------- | ---------------- | ------- | -------
0            | Authorise  | TCP   | all       | blank       | blank            | established | Enabled
1            | Authorise  | IPv4  | Failover IP |    blank  | blank            | blank    | Enabled
19           | Refuse  | IPv4  | All |    blank  | blank            | blank    | Enabled
