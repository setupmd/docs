...
## You Will Need
* An Ubuntu server with at least 4 CPUs, 8GB RAM and 100GB disk - this tutorial assumes that the panel and Wings are running on the same machine.
OpenVZ or LXC servers will not work with Docker, which is required for the Wings backend to work properly. This tutorial uses Ubuntu 20.04 as the base OS.
...
This tutorial assumes the use of PHP 8.1
