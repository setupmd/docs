...
Those that carry the `project lead` role are the core representatives of the project and should be the ones who are consulted on any issues within. An invite to our server can always be found by using the 
