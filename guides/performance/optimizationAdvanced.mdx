---
slug: /optimizing/advanced
title: Advanced Optimization Checklist
...
#### ajLeaderboards
ajLeaderboards is rather unstable and somewhat unoptimized. We suggest that you use LeaderHeadsRevamped instead. Although it has not received an update in a while, it still functions as advertised; However, might be limited.
